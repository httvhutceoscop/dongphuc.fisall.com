	...
	<?php if ( (!isset($theretailer_theme_options['ratings_styles'])) || ($theretailer_theme_options['ratings_styles'] == 0) ) : ?>
		...
		<style>
			...
			.star-rating {
				...
				height: 16px;
				margin:0;
				background: url('<?php bloginfo('template_url'); ?>/images/star.png') repeat-x left 0 !important;
			}
			
			.star-rating span {
				background: url('<?php bloginfo('template_url'); ?>/images/star.png') repeat-x left -32px !important;
				height: 0;
				padding-top: 16px;
				overflow: hidden;
				float: left;
			...
			{
				background:url('<?php bloginfo('template_url'); ?>/images/star.png') repeat-x left -18px !important;
			}
			
			p.stars span a.active{
				background:url('<?php bloginfo('template_url'); ?>/images/star.png') repeat-x left -34px !important;
			}
			...
			.woocommerce-page p.stars a.star-1 {
				...
				border:0;
				background:url('<?php bloginfo('template_url'); ?>/images/star.png') repeat-x left -2px;
				margin-right:5px;
			}
