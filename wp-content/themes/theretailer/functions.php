...
//if ( is_admin() ) { include_once (TEMPLATEPATH . '/inc/update.php'); }
...
function theretailer_ajax_added_to_cart() {
	...
	function theretailer_refresh_minicart_4($fragments) 
	{
        ...
        <span class="items_number"><?php echo $woocommerce->cart->cart_contents_count; ?></span>
